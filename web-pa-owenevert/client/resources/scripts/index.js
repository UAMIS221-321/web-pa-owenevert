...
function handleEditClick()
{
    makeEditable();
    hideButtons();
    var buttonHtml = "<button class=\"btn btn-primary btn-lg\" oneclick=\"handleEditSave("+myBook.id+")\">Save/button>"
...
function populateForm()
{
    ...
    document.getElementById("bookGnere").value = myBook.genre;
    document.getElementById("bookAvlb").value = myBook.numAvlb;
...
function makeReadOnly()
{
    ...
    document.getElementById("bookGnere").readOnly=true;
